(function installNetworkCodec(root) {
  ...
  const TAU = Math.PI * 2;
  const ENEMY_ARCHETYPE_IDS = ["scout", "forager", "courier", "charger", "cutter", "coiler", "warden", "liner", "skitter", "headhunter"];
  const ENEMY_BEHAVIOR_STATES = ["roam", "forage", "intercept", "orbit", "escort", "straight", "scramble", "aim", "lock", "rush"];
