(() => {
  ...
  const modules = [
    ...
    { id: "echo", name: "回声弹匣", category: "输出", color: "#ff8bd7", shape: "capsule", cooldown: "被动效果", desc: "头部每次开火时，每节回声弹匣追加1枚偏转弹，造成1伤害。" },
    ...
    { id: "repulse", name: "斥力环节", category: "防御", color: "#75dfff", shape: "ring", cooldown: "被动效果", desc: "持续将靠近蛇头的敌蛇航向推向外侧；首节作用半径110px，之后每节+20px。" },
    { id: "armor", name: "黑曜装甲", category: "防御", color: "#b7c0ce", shape: "square", cooldown: "被动效果", desc: "每节使护盾与相位的冷却时间-18%，乘法叠加。" },
    ...
    { id: "stabilizer", name: "平衡陀螺", category: "防御", color: "#67d5c8", shape: "ring", cooldown: "被动效果", desc: "每节使反弹后的减速时间-25%、转向锁定时间-20%，乘法叠加。" },
    { id: "magnet", name: "磁吸环节", category: "辅助", color: "#f5cb4c", shape: "ring", cooldown: "被动效果", desc: "每节使蛇头吃球范围+0.55格。" },
    { id: "haste", name: "涡轮节", category: "辅助", color: "#ff8457", shape: "triangle", cooldown: "被动效果", desc: "每节提高4.5%移动速度，并增加0.18弧度/秒转向速度。" },
    { id: "chronos", name: "时缓晶节", category: "辅助", color: "#91a7ff", shape: "diamond", cooldown: "被动效果", desc: "每节使所有敌蛇移动速度-8%，乘法叠加。" },
    { id: "tractor", name: "引力环节", category: "辅助", color: "#3ed8b5", shape: "ring", cooldown: "被动效果", desc: "吸引附近的球；首节范围3.5格、牵引速度1.8格/秒，之后每节分别+1.1格、+0.45格/秒。" },
    { id: "fortune", name: "幸运星节", category: "辅助", color: "#ffd166", shape: "star", cooldown: "被动效果", desc: "击破敌蛇时，每节+18%概率额外掉落1枚球，上限85%；每满3节再+1枚球。" },
    { id: "guidance", name: "弹道校准节", category: "辅助", color: "#78a9ff", shape: "capsule", cooldown: "被动效果", desc: "每节使所有子弹飞行速度+12%，并增加0.35弧度/秒追踪速度。" },
    { id: "feast", name: "吞噬涡轮", category: "辅助", color: "#ffb23f", shape: "triangle", cooldown: "被动效果", desc: "每次吃球后2.5秒内，每节提高12%移动速度；再次吃球刷新持续时间。" },
    { id: "salvage", name: "回收炉节", category: "恢复", color: "#c7f464", shape: "hex", cooldown: "被动效果", desc: "技能每削去1节敌蛇身体，每节有14%概率将其回收为球，上限72%。" },
    ...
    { id: "amplifier", name: "超频增幅节", category: "辅助", color: "#f2f5fa", shape: "capsule", cooldown: "被动效果", desc: "每节使蛇头及定时输出机体的冷却时间-14%，乘法叠加。" },
    ...
    { id: "buffer", name: "动能缓冲节", category: "防御", color: "#8fa6ad", shape: "square", cooldown: "被动效果", desc: "每节使玩家受到的物理击退力度-18%，乘法叠加。" },
    { id: "decoy", name: "诱导涂层", category: "防御", color: "#ff7a90", shape: "diamond", cooldown: "被动效果", desc: "每节使敌蛇对玩家身体的避让强度-12%，最低保留45%。" },
    { id: "emergency", name: "应急屏障节", category: "防御", color: "#62e6bf", shape: "hex", cooldown: "被动效果", desc: "身体吃球后全身无敌；首节持续0.37秒，之后每节+0.12秒，上限0.9秒。" },
    { id: "collector", name: "全身采集节", category: "辅助", color: "#d4f05c", shape: "ring", cooldown: "被动效果", desc: "每节使自身所有身体节的吃球半径+0.09格。" },
    { id: "beacon", name: "增压信标", category: "辅助", color: "#ffc857", shape: "star", cooldown: "被动效果", desc: "每节使波次倒计时速度+7%。" },
    { id: "momentum", name: "冲量增幅器", category: "辅助", color: "#ff965c", shape: "triangle", cooldown: "被动效果", desc: "每节使敌蛇受到的物理击退力度+18%。" },
    { id: "progressor", name: "临界推进节", category: "辅助", color: "#38d6c5", shape: "capsule", cooldown: "被动效果", desc: "升级进度越高移动越快；经验满时，每节最多提高8%移动速度。" },
    { id: "nursery", name: "尾部育成舱", category: "恢复", color: "#ff8ec7", shape: "circle", cooldown: "", activeCooldown: true, desc: "每节独立计时，定期在蛇尾附近生成1枚球。" },
    { id: "cache", name: "战果缓存节", category: "恢复", color: "#b7e36b", shape: "hex", cooldown: "被动效果", desc: "首节每击破5名敌人生成1枚球；之后每节使需求-1，最低每2次击破。" }
  ];
