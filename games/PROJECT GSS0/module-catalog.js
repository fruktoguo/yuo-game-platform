(() => {
  ...
  const moduleBlueprints = [
    ...
    { id: "echo", name: "回声弹匣", category: "输出", color: "#ff8bd7", shape: "capsule", cooldown: "被动效果", desc: "蛇头撞击敌蛇时，每级发射1枚偏转弹，造成1伤害。" },
    ...
    { id: "shield", name: "碧玉护盾", category: "防御", color: "#48e0bf", shape: "hex", cooldown: "", activeCooldown: true, desc: "抵消1次头部撞上敌蛇身体时受到的伤害，并获得短暂无敌。" },
    { id: "phase", name: "幻相节", category: "防御", color: "#bb8cff", shape: "diamond", cooldown: "", activeCooldown: true, desc: "抵消1次头部撞上敌蛇身体时受到的伤害，短暂无敌并保持航向。" },
