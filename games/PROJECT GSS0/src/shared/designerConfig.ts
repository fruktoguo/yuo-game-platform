...
export const DESIGNER_BALANCE = Object.freeze({
  ...
  cameraPseudo3DPerspective: numberSetting('cameraPseudo3DPerspective', 0.11, 0, 0.4),
  cameraPseudo3DForeshortening: numberSetting('cameraPseudo3DForeshortening', 0.12, 0, 0.4),
  cameraPseudo3DOverscan: numberSetting('cameraPseudo3DOverscan', 0.36, 0, 1),
  cameraPseudo3DResponse: numberSetting('cameraPseudo3DResponse', 5.5, 0.1, 30),
  cameraAimLookAheadCells: numberSetting('cameraAimLookAheadCells', 1.25, 0, 8),
  ...
  entityShadowOpacity: numberSetting('entityShadowOpacity', 0.42, 0, 1),
  entityShadowOffsetPixels: numberSetting('entityShadowOffsetPixels', 10, 0, 40),
  entityShadowDirectionDegrees: numberSetting('entityShadowDirectionDegrees', 56, -180, 180),
  entityShadowWidthScale: numberSetting('entityShadowWidthScale', 1.45, 0.25, 4),
  entityShadowHeightScale: numberSetting('entityShadowHeightScale', 0.52, 0.1, 2),
  entityShadowHeightStretch: numberSetting('entityShadowHeightStretch', 0.28, 0, 1.5),
  entityShadowBlurPixels: numberSetting('entityShadowBlurPixels', 8, 0, 24),
