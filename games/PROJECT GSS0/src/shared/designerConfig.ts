...
export const DESIGNER_BALANCE = Object.freeze({
  ...
  entityShadowOpacity: numberSetting('entityShadowOpacity', 0.54, 0, 1),
  ...
  entityShadowWidthScale: numberSetting('entityShadowWidthScale', 1.3, 0.25, 4),
  entityShadowHeightScale: numberSetting('entityShadowHeightScale', 0.48, 0.1, 2),
  entityShadowHeightStretch: numberSetting('entityShadowHeightStretch', 0.24, 0, 1.5),
  entityShadowBlurPixels: numberSetting('entityShadowBlurPixels', 6, 0, 24),
