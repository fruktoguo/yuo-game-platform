...
export const DESIGNER_BALANCE = Object.freeze({
  ...
  entityShadowOpacity: numberSetting('entityShadowOpacity', 0.72, 0, 1),
  ...
  entityShadowWidthScale: numberSetting('entityShadowWidthScale', 1.48, 0.25, 4),
  entityShadowHeightScale: numberSetting('entityShadowHeightScale', 0.58, 0.1, 2),
  entityShadowHeightStretch: numberSetting('entityShadowHeightStretch', 0.3, 0, 1.5),
  entityShadowBlurPixels: numberSetting('entityShadowBlurPixels', 4, 0, 24),
  entityContactShadowOpacity: numberSetting('entityContactShadowOpacity', 0.4, 0, 1),
  entityContactShadowScale: numberSetting('entityContactShadowScale', 0.72, 0.1, 1.5),
