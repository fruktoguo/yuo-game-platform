...
export const PLAYER_SEGMENT_SPACING = DESIGNER_BALANCE.playerSegmentSpacing;
export const ENEMY_SEGMENT_SPACING = DESIGNER_BALANCE.enemySegmentSpacing;
export const SNAKE_VISUAL_SCALE = DESIGNER_BALANCE.snakeVisualScale;
