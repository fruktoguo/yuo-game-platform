...
const CLASSIC_SCRIPTS = ['designer-config.js', 'spawn-planner.js', 'game.js', 'network-codec.js', 'network-player-prediction.js', 'network-food-claims.js', 'network-projectiles.js'] as const;
