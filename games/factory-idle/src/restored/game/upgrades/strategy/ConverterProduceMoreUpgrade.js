 ...
 * AMD 模块：game/upgrades/strategy/ConverterProduceMoreUpgrade
 */
define("game/upgrades/strategy/ConverterProduceMoreUpgrade", ["./AbstractUpgrade"], function(e) {
  ...
  return t.prototype.updateMap = function(e2) {
    ...
    e2.byComponent[this.meta.componentId].runningCostPerTickIncrease += t2, e2.byComponent[this.meta.componentId].convertProduceMoreBonus += t2, e2.byComponent[this.meta.componentId].maxStorageBonus += t2;
    ...
    return "<b>" + e2.name + '</b> produces <b class="green">' + t2.next + "</b> more resources.<br />" + (this.meta.noRunningCost ? "" : 'Increases running cost by <b class="red">' + t2.next + "</b><br />") + '<br />More production per component with less raw materials, but expenses are proportionally the same. More production per component => more resources to sell.<br /><br /><b>Current total increase: </b><b class="green">' + t2.total + "</b> ";
  }, t;
});
