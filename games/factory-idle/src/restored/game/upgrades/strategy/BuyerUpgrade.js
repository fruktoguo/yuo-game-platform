 ...
 * AMD 模块：game/upgrades/strategy/BuyerUpgrade
 */
define("game/upgrades/strategy/BuyerUpgrade", ["./AbstractUpgrade"], function(e) {
  ...
  return t.prototype.updateMap = function(e2) {
    ...
    e2.byComponent[this.meta.componentId].runningCostPerTickIncrease += t2, e2.byComponent[this.meta.componentId].buyAmountBonus += t2, e2.byComponent[this.meta.componentId].maxStorageBonus += t2;
    ...
    return "<b>" + e2.name + '</b> buys <span class="green">' + t2.next + "</span> more resources.<br />" + (this.meta.noRunningCost ? "" : 'Increases running cost by <b class="red">' + t2.next + "</b><br />") + '<br />More production per component, but expenses are proportionally the same. More production per component => more resources to sell.<br /><br /><b>Current total buy resources bonus: </b><b class="green">' + t2.total + "</b> ";
  }, t;
});
